...
import eu.hadzhipopov.power.config.audit.AuditEventConverter;
import eu.hadzhipopov.power.domain.PersistentAuditEvent;
import eu.hadzhipopov.power.repository.PersistenceAuditEventRepository;
import eu.hadzhipopov.power.service.AuditEventService;
